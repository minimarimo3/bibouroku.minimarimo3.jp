/*
このTypstテンプレートは @minimarimo3@misskey.io によって作成され、 WTFPL(Do What The Fuck You Want To Public License) に従って配布されています。
連絡は @minimarimo3@misskey.io (Misskey) か @katayaura (X) にどうぞ。
...
#align(center, text(10pt)[
  この文章は #氏名 が書きました。
  最終更新日は #最終更新日.display("[year]年 [month]月 [day]日")です。
])
#linebreak()
